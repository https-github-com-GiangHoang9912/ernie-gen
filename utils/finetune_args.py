...
model_g.add_arg("ernie_config_path", str, "ernie_gen_base/ernie_config.json", "Path to the json file for ernie model config.")
model_g.add_arg("init_checkpoint", str, None, "Init checkpoint to resume training from.")
model_g.add_arg("init_pretraining_params", str, "ernie_gen_base/params",
...
train_g.add_arg("epoch", int, 10, "Number of epoches for fine-tuning.")
...
train_g.add_arg("tgt_type_id", int, 3, "for seq2seq task.")
train_g.add_arg("beam_size", int, 5, "for seq2seq task.")
train_g.add_arg("do_decode", bool, True, "for seq2seq task.")
train_g.add_arg("noise_prob", float, 0.7, "mask prob")
train_g.add_arg("label_smooth", float, 0.1, "label smooth")
train_g.add_arg("random_noise", bool, True, "noise is random")
...
data_g.add_arg("train_set", str, "./datasets/squad_qg/train.tsv", "Path to training data.")
data_g.add_arg("test_set", str, "./datasets/squad_qg/test.tsv", "Path to test data.")
data_g.add_arg("dev_set", str, "./datasets/squad_qg/dev.tsv", "Path to validation data.")
data_g.add_arg("pred_set", str, "./datasets/squad_qg/text.tsv", "Path to pred data.")
data_g.add_arg("vocab_path", str, "ernie_gen_base/vocab.txt", "Vocabulary path.")
data_g.add_arg("src_vocab_path", str, None, "Vocabulary path.")
data_g.add_arg("max_seq_len", int, 512, "Number of words of the longest seqence.")
data_g.add_arg("max_tgt_len", int, 96, "for seq2seq task.")
data_g.add_arg("max_src_len", int, 512, "for seq2seq task.")
data_g.add_arg("max_dec_len", int, 48, "for seq2seq task.")
...
data_g.add_arg("length_penalty", float, 1.0, "length_penalty")
data_g.add_arg("continuous_position", bool, True, "position is continuous")
...
run_type_g.add_arg("save_and_valid_by_epoch", bool, True, "save_and_valid_by_epoch")

#run_type_g.add_arg("eval_script", str, None, "eval_script")
run_type_g.add_arg("eval_script", action=CustomAction, type=str, nargs='+', help="eval_script", default="bash ./eval/tasks/squad_qg/eval.sh")
run_type_g.add_arg("eval_mertrics", str, "Bleu_4,METEOR,ROUGE_L", "eval_mertrics")
